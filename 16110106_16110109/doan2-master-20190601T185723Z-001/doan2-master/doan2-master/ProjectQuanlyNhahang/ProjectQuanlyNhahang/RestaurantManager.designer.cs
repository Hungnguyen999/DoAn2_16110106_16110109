...
namespace ProjectQuanlyNhahang
{
    ...
    partial void InsertCHITIETHOADONNH(CHITIETHOADONNH instance);
    partial void UpdateCHITIETHOADONNH(CHITIETHOADONNH instance);
    partial void DeleteCHITIETHOADONNH(CHITIETHOADONNH instance);
    ...
    partial void DeleteNHANVIEN(NHANVIEN instance);
		...
		public RestaurantManagerDataContext() : 
				base(global::ProjectQuanlyNhahang.Properties.Settings.Default.QuanLyNhaHangConnectionString5, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<CHITIETHOADONNH> CHITIETHOADONNHs
		{
			get
			{
				return this.GetTable<CHITIETHOADONNH>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CHITIETHOADONNH")]
	public partial class CHITIETHOADONNH : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<HOADONNH> _HOADONNH;
    ...
    partial void OnTrangThaiChanged();
		...
		{
			this._HOADONNH = default(EntityRef<HOADONNH>);
		...
		public int MaHD
		{
			...
			set
			{
				if ((this._MaHD != value))
				{
					if (this._HOADONNH.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="HOADONNH_CHITIETHOADONNH", Storage="_HOADONNH", ThisKey="MaHD", OtherKey="ID", IsForeignKey=true)]
		public HOADONNH HOADONNH
		{
			get
			{
				return this._HOADONNH.Entity;
			}
			set
			{
				HOADONNH previousValue = this._HOADONNH.Entity;
				if (((previousValue != value) 
							|| (this._HOADONNH.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._HOADONNH.Entity = null;
						previousValue.CHITIETHOADONNHs.Remove(this);
					}
					this._HOADONNH.Entity = value;
					if ((value != null))
					{
						value.CHITIETHOADONNHs.Add(this);
						this._MaHD = value.ID;
					}
					else
					{
					...
					this.SendPropertyChanged("HOADONNH");
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NGUYENLIEU_CHITIETHOADONNH", Storage="_NGUYENLIEU", ThisKey="SanPham", OtherKey="ID", IsForeignKey=true)]
	...
	public partial class HOADONNH : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<CHITIETHOADONNH> _CHITIETHOADONNHs;
    ...
    partial void OnTrangThaiChanged();
		...
		public HOADONNH()
		{
			this._CHITIETHOADONNHs = new EntitySet<CHITIETHOADONNH>(new Action<CHITIETHOADONNH>(this.attach_CHITIETHOADONNHs), new Action<CHITIETHOADONNH>(this.detach_CHITIETHOADONNHs));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="HOADONNH_CHITIETHOADONNH", Storage="_CHITIETHOADONNHs", ThisKey="ID", OtherKey="MaHD")]
		public EntitySet<CHITIETHOADONNH> CHITIETHOADONNHs
		{
			get
			{
				return this._CHITIETHOADONNHs;
			}
			set
			{
				this._CHITIETHOADONNHs.Assign(value);
			}
		}
		...
		private void attach_CHITIETHOADONNHs(CHITIETHOADONNH entity)
		{
			this.SendPropertyChanging();
			entity.HOADONNH = this;
		}
		
		private void detach_CHITIETHOADONNHs(CHITIETHOADONNH entity)
		{
			this.SendPropertyChanging();
			entity.HOADONNH = null;
		}
	}
    ...
    partial void OnTenNVChanging(int value);
    partial void OnTenNVChanged();
    ...
    partial void OnStatusChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TenNV", DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int TenNV
		{
			get
			{
    ...
    partial void OnTrangThaiChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NGUYENLIEU_CHITIETHOADONNH", Storage="_CHITIETHOADONNHs", ThisKey="ID", OtherKey="SanPham")]
		public EntitySet<CHITIETHOADONNH> CHITIETHOADONNHs
		{
			get
			{
